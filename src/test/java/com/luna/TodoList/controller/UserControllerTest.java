...
//
//                when(userRepository.findByUsername(userRequestDto.getUsername()).getUserId()).thenReturn(1L);
//                when(userService.deleteUserById(1L,userRequestDto)).thenReturn("SUCCESS");
//
...
//
//                verify(userService,times(1)).deleteUserById(1L,userRequestDto);
//
//            }
//        }
//
...
//            @Test
//            public void should_delete_user_by_id() throws Exception{
//                when(userService.deleteUserById(1L,userRequestDto)).thenThrow(new NotFoundException("User Not Found"));
//
//                mockMvc.perform(MockMvcRequestBuilders.delete("/users/{id}" ,1L)
//                        .contentType(MediaType.APPLICATION_JSON)
//                        .accept(MediaType.APPLICATION_JSON))
